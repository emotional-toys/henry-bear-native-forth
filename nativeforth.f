...
\ The following words were defined natively on the original x86 forth.
\ In this ARM port, they are defined in forth.
...
\
\	The first part of this tutorial is in nativeforth.S.
\
\	SETTING UP ----------------------------------------------------------------------
\
